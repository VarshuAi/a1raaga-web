...
import { APK_SIZE as DEFAULT_APK_SIZE, APK_URL as DEFAULT_APK_URL, RELEASES_URL, SHA256 as DEFAULT_SHA256, VERSION_JSON_URL } from "@/lib/site";
...
export function DownloadSection() {
  ...
  const [releaseNotes, setReleaseNotes] = useState<string[]>([
    "Official Launch of A1 Swaara with cinematic obsidian UI",
    "High-Speed 320 kbps Stream Downloader with circular percentage tracking",
    "Story Creator Studio (Instagram/WhatsApp Story Cards and 30s/60s Video Export)",
    "Multi-language discovery matrix across 12 Indian regional languages",
    "Synchronized karaoke lyrics with 335dp hero album artwork studio",
    "Studio Parametric Equalizer with custom acoustic presets & Bass Boost",
  ]);
  ...
  const META = [
    ...
    { icon: Calendar, label: "Released", value: "Aug 31, 2026" },
    { icon: ShieldCheck, label: "Cost", value: "Free forever" },
  ];

  const INSTALL_STEPS = [
    { title: "Download the APK", desc: "Grab the official signed release below — direct high-speed GitHub link." },
    { title: "Allow Install", desc: "Android will prompt once to allow app installs from your browser." },
    { title: "Verify Checksum", desc: "Match the SHA-256 hash against the checksum shown below." },
    { title: "Pure Sonic Joy", desc: "Open A1 Swaara, pick your languages, and immerse in 320 kbps sound." },
  ];
  ...
  const CHANGELOG = [
    {
      ...
      title: "A1 Swaara v1.0.0 Official Release",
      items: releaseNotes,
      current: true,
    },
    {
      v: "Next",
      date: "Upcoming",
      title: "Swaara Cloud Sync & Social Jam",
      items: ["Collaborative real-time listening rooms", "Lossless FLAC studio tier", "Custom story canvas templates"],
      upcoming: true,
    },
  ];
    ...
    <section id="download" className="relative overflow-hidden py-28 sm:py-36">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <SectionHeading
          ...
          description="Free forever. No sign up, no ads, no telemetry — pure music fidelity."
        />
        ...
        <div className="grid gap-4 pt-16 lg:grid-cols-5">
            ...
            <div className="glass relative h-full overflow-hidden rounded-3xl p-7 sm:p-9">
              ...
              <div className="relative">
                <div className="flex flex-wrap items-center gap-3">
                  <span className="rounded-full bg-gradient-to-r from-accent to-accent-2 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-white shadow-[0_0_10px_var(--glow)]">
                    Latest Release
                  </span>
                ...
                <div className="grid grid-cols-2 gap-3 pt-8 sm:grid-cols-4">
                  {META.map((m) => (
                    <div key={m.label} className="rounded-2xl border border-foreground/10 bg-foreground/[0.02] p-3.5">
                      <m.icon size={15} className="text-accent" />
                ...
                <div className="flex flex-wrap items-center gap-3 pt-8">
                  <a href={apkUrl} target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="group/dl shadow-[0_0_20px_var(--glow)]">
                ...
                <p className="flex items-center gap-2 pt-4 text-xs text-muted-foreground">
                  ...
                  Signed release · SHA-256 verified on GitHub
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal className="lg:col-span-2" delay={0.1}>
            <div className="glass h-full rounded-3xl p-6 sm:p-7">
              <h4 className="font-display text-lg font-semibold">Release Timeline</h4>
                  ...
                  <div key={c.v} className="relative">
                    <span
                      className={`absolute -left-5 top-1 rounded-full ${
                        c.upcoming
                          ? "size-[11px] animate-pulse-soft bg-gradient-to-r from-accent-3 to-accent-2 shadow-[0_0_14px_rgba(32,207,255,0.6)]"
                          : c.current
        ...
        <Reveal className="pt-20 text-center">
          <blockquote className="mx-auto max-w-2xl">
            <p className="font-display text-3xl font-medium leading-snug tracking-tight sm:text-4xl">
              “Where words fail,
              <br />
              <span className="text-gradient">A1 Swaara speaks.”</span>
            </p>
            <footer className="dot-matrix pt-4 text-[10px] text-muted-foreground">
              Pure Sonic Experience
            </footer>
          </blockquote>
        </Reveal>
